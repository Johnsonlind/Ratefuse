...
function pickLogo(
  ...
  return toTmdbImagePath(pickPreferredTmdbImagePath(logos, originalLanguage), HERO_IMAGE_SIZE);
}
...
function pickHeroPosterImage(
  ...
  const preferredPosterPath = pickPreferredTmdbImagePath(posters, originalLanguage);
  return (
    toTmdbImagePath(preferredPosterPath, HERO_IMAGE_SIZE) ||
